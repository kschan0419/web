...
<head>
  ...
  <title>My Bag Ordering System : Staffs</title>
  <!-- Bootstrap -->
  ...
  <div class="row">
    ...
    <div class="form-group">
      ...
      <input name="password" type="password"  class="form-control" id="staffpassword" placeholder="Password" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_password']; ?>" required>
        ...
        <div class="form-group">
          <label for="staffrepassword" class="col-sm-3 control-label">Retype Password</label>
          <div class="col-sm-9">
      <input name="repassword" type="password"  class="form-control" id="staffrepassword" placeholder="Retype Password" required>
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_staffs_a160841_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
