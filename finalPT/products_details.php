...
<head>
  ...
  <title>My Bag Ordering System : Products Details</title>
  <!-- Bootstrap -->
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-5 col-sm-offset-1 col-md-4 col-md-offset-2 well well-sm text-center">
      <?php if ($readrow['fld_product_image'] == "" ) {?> 
        <img src="products/no-image.png" class="img-responsive"> 
      <?php }
      else { ?>
    ...
    <div class="col-xs-12 col-sm-5 col-md-4">
      ...
      <table class="table">
        ...
        <tr>
          ...
          <td>RM <?php $num = $readrow['fld_product_price']; $formattedNum = number_format($num, 2);
